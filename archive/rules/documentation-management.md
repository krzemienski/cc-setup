...
- Before committing documentation, verify all status labels (e.g., 'Future', 'Implemented', 'Planned') match actual codebase state
- Cross-check route/API docs against real code — grep for actual route handlers before documenting endpoints

...
# │   node $HOME/.claude/hooks/notifications/notify.cjs                           │
# │                                                                         │
...
echo "   Use: node $HOME/.claude/hooks/notifications/notify.cjs" >&2
echo "   See: $HOME/.claude/hooks/notifications/docs/discord-hook-setup.md" >&2
exit 1

# --- LEGACY CODE BELOW (kept for reference) ---

# Load environment variables with priority: process.env > $HOME/.claude/.env > $HOME/.claude/hooks/.env
load_env() {
    # 1. Start with lowest priority: $HOME/.claude/hooks/.env
    ...
    # 2. Override with $HOME/.claude/.env
